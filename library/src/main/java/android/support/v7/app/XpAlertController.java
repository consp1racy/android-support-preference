...
class XpAlertController {
    ...
    public <T extends AppCompatActivity & DialogInterface> XpAlertController(T activity) {
        this(activity, activity, activity.getDelegate(), activity.getWindow());
    }

    public XpAlertController(Context context, DialogInterface di, AppCompatDelegate delegate, Window window) {
        mContext = context;
//        mDialog = di;
        mDialogInterface = di;
    ...
    public void installContent() {
        ...
        mAppCompatDelegate.requestWindowFeature(Window.FEATURE_NO_TITLE);
        final int contentView = selectContentView();
        mAppCompatDelegate.setContentView(contentView);
        setupView();
    }
    ...
    public static class AlertParams {
        ...
        public void apply(XpAlertController dialog) {
            if (mCustomTitleView != null) {
        ...
        private void createListView(final XpAlertController dialog) {
