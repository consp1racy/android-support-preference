...
abstract class AlertActivity extends AppCompatActivity implements DialogInterface {
     ...
     * @see #mAlertParams
     */
    protected XpAlertController mAlert;

    /**
     * The parameters for the alert.
     */
    protected XpAlertController.AlertParams mAlertParams;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        mAlert = new XpAlertController(this);
        mAlertParams = new XpAlertController.AlertParams(this);
    }
