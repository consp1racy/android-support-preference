...
public class RingtonePreference extends Preference
    ...
    public RingtonePreference(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        init(context, attrs, defStyleAttr, R.style.Preference_Material_RingtonePreference);
    }
...
//        Intent intent = new Intent(RingtoneManager.ACTION_RINGTONE_PICKER);
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
            ...
            PreferenceFragment owningFragment = PreferenceManagerCompat.getFragment(getPreferenceManager());
    ...
    protected void onAttachedToHierarchy(@NonNull PreferenceManager preferenceManager) {
        ...
        PreferenceManagerCompat.registerOnActivityResultListener(preferenceManager, this);
        mRequestCode = PreferenceManagerCompat.getNextRequestCode(preferenceManager);
    }
