...
```groovy
dependencies {
    implementation 'net.xpece.android:support-preference:2.3.0'
...
```groovy
dependencies {
    implementation 'net.xpece.android:support-preference-color:2.3.0'
}
```
...
```groovy
dependencies {
    implementation 'net.xpece.android:support-spinner:2.3.0'
}
```
