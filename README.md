...
```groovy
dependencies {
    compile 'net.xpece.android:support-preference:1.2.8'
...
```groovy
dependencies {
    compile 'net.xpece.android:support-preference-color:1.2.8'
}
```
...
```groovy
dependencies {
    compile 'net.xpece.android:support-spinner:1.2.8'
}
```
