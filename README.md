...
Version 1.3.0 is compatible with support libraries down to 23.2.0.
...
```groovy
dependencies {
    compile 'net.xpece.android:support-preference-color:1.3.0'
}
```
...
```groovy
dependencies {
    compile 'net.xpece.android:support-spinner:1.3.0'
}
```
